...
# NOTEARS availability: use causal_discovery.algos.notears.NoTears only
has_notears = False
notears_impl = None
NoTears = None
try:
    from causal_discovery.algos.notears import NoTears as _NoTears
    NoTears = _NoTears
    has_notears = True
    notears_impl = "causal_discovery"
except Exception:
    has_notears = False
    notears_impl = None
...
# try:
#     lagged.to_parquet("/dbfs/tmp/causal_metrics_matrix.parquet")
